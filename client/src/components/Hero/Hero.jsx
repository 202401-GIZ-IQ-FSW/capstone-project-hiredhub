  ...
  return (
    <div>
      <div className="grid xl:grid-cols-2 sm:grid-cols-1 mx-9 mt-9  justify-items-center ">
        <div className="flex flex-col justify-center xl:mx-12 sm:mx-4 gap-10 xl:mb-4 sm:mb-7">
          <div className="flex flex-col gap-5">
            <h1 className="font-mulish xl:text-5xl sm:text-4xl font-semibold xl:text-left sm:text-center ">
              Let the jobs Find you
            </h1>
            <h3 className="xl:text-2xl sm:text-xl font-lato xl:w-full xl:text-left sm:text-center sm:w-[500px]">
              Create your free profile to get interview invites and jobs that
              work for you.
            </h3>
          </div>
          <div className="flex flex-col gap-5">
            <h2 className="xl:text-4xl sm:text-3xl font-mulish font-semibold xl:text-left sm:text-center">
              Skip the paperwork
            </h2>
            <h4 className="xl:text-2xl sm:text-xl font-lato">
