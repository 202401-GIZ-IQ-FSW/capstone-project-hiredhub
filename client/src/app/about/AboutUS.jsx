...
const AboutUS = () => {
  ...
  <div class="container mx-auto p-6">
    <div class="my-8">
      <h2 class="text-2xl font-semibold mb-4 text-[#40A578]">
        About HiredHub!
      </h2>
      ...
      <div class="my-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-white hover:bg-[#263238] hover:text-white rounded-lg shadow-md p-6">
            <h2 class="text-xl font-semibold mb-4 hover:text-white">
              What is the value we provide?
            </h2>
            <p class="text-gray-700 hover:text-[#40A578] leading-relaxed">
          ...
          <div class="bg-white hover:bg-[#263238] rounded-lg shadow-md p-6 hover:text-white">
            <h2 class="text-xl font-semibold mb-4 hover:text-white">
              What is our Mission?
            </h2>
            <p class="text-gray-700 leading-relaxed hover:text-[#40A578]">
